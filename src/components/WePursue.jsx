      ...
      <div className="container xl:max-w-[1140px] px-3 mx-auto">
        <div className=" flex flex-col-reverse lg:flex-row justify-center items-center flex-wrap">
          <div className="  lg:w-7/12 mt-6 lg:mt-0">
            <h3 className=" font-bahnschrift text-3xl md:text-[38px] font-light text-black lg:leading-10">
              We Pursue
              <span className="font-bold text-orange">All Liable</span> Parties
            </h3>
            <p className=" text-base font-normal font-Poppins text-black opacity-70 mt-4 lg:max-w-[573px]">
              ...
              <div className=" flex gap-3 items-center mt-3 sm:mt-4">
                ...
                <p className=" font-normal font-Poppins text-base xl:text-lg text-black max-w-[498px]">
                  Any potential law enforcement officials who exercised
                  negligence in allowing the abuse to occur
                </p>
              </div>
                <p className=" text-base font-normal font-Poppins text-black opacity-70 mt-4 max-w-[573px]">
