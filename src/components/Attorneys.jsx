    ...
    <div className=" mt-16 relative z-0">
      <div className="container xl:max-w-[1140px] mx-auto  px-3">
        <div className=" bg-main py-11 rounded flex flex-col justify-center items-center px-4">
          ...
          <button className=" font-Poppins font-medium text-lg bg-white py-[18px] px-9 text-black rounded-[500px] mt-[42px] hover:bg-main hover:border hover:border-white hover:text-white border-main hover:shadow-lg hover:shadow-white transition-all ease-in-out duration-300">
            Join Our Team Today
          </button>
        </div>
      </div>
